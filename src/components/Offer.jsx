          ...
          <div className="relative z-10">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <div className="flex items-center gap-2 px-4 py-2 text-sm font-black tracking-wider text-white uppercase rounded-full bg-sky-500">
                <Star className="w-4 h-4" aria-hidden="true" /> ĐẶC BIỆT
              </div>
            ...
            <h3 className="mb-6 text-2xl font-bold leading-tight lg:text-4xl text-sky-950">
                ...
                <div className="p-6 bg-white border shadow-lg rounded-2xl lg:p-8 shadow-sky-100/50 border-sky-100">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 border-2 shrink-0 lg:w-32 lg:h-32 bg-sky-100 rounded-2xl border-sky-200">
                      <Trophy className="w-12 h-12 text-sky-500" aria-hidden="true" />
                    </div>
                    <div>
            ...
            <div className="relative z-10">
              <div className="mb-10 text-center">
                <p className="mb-4 font-semibold tracking-widest uppercase text-sky-200">
                  <span aria-hidden="true">🎉</span> Nhân dịp kỷ niệm 15 năm hành trình HLV chăm sóc sức khỏe cá nhân
                </p>
              ...
              <div className="grid grid-cols-1 gap-6 mb-10 md:grid-cols-3">
                <div className="p-6 text-center transition-colors border bg-white/10 backdrop-blur-sm rounded-3xl border-white/20 hover:bg-white/15">
                  <Calendar className="w-10 h-10 mx-auto mb-4 text-sky-200" aria-hidden="true" />
                ...
                <div className="p-6 text-center transition-colors border bg-white/10 backdrop-blur-sm rounded-3xl border-white/20 hover:bg-white/15">
                  <Users className="w-10 h-10 mx-auto mb-4 text-sky-200" aria-hidden="true" />
                ...
                <div className="p-6 text-center transition-colors border bg-white/10 backdrop-blur-sm rounded-3xl border-white/20 hover:bg-white/15">
                  <Trophy className="w-10 h-10 mx-auto mb-4 text-sky-200" aria-hidden="true" />
              ...
              <div className="p-8 mb-8 text-center bg-white shadow-xl rounded-4xl lg:p-10">
                ...
                <h3 className="mb-4 text-4xl font-black lg:text-6xl text-sky-600">HOÀN TOÀN MIỄN PHÍ!</h3>
              ...
              >
                <div className="flex items-center justify-center gap-3 mb-3">
                  <Clock className="w-6 h-6 text-sky-200" aria-hidden="true" />
              ...
              <div className="text-center">
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-10 py-5 text-xl font-black text-white transition-colors rounded-full shadow-2xl lg:py-6 bg-sky-950 lg:text-2xl hover:bg-black inline-block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-sky-600"
                >
