      ...
      <Container>
        ...
        <div className="grid grid-cols-1 gap-6 mb-16 md:grid-cols-3 lg:gap-8 xl:gap-12">
          <Card className="transition-colors hover:border-sky-200">
            <Smile className="w-12 h-12 mb-8 lg:w-14 lg:h-14 text-sky-500" />
          ...
          <Card className="transition-colors hover:border-sky-200">
            <Frown className="mb-8 text-blue-500 w-14 h-14" />
            <h3 className="mb-4 text-2xl font-bold leading-snug text-sky-950">Tự ti mỗi khi đứng trước gương?</h3>
            <p className="leading-relaxed text-slate-600">Mỗi lần đứng trước gương, bạn luôn tự ti về thân hình đồ sộ của mình và cảm thấy già hơn so với người bạn đời?</p>
          </Card>
          <Card className="transition-colors hover:border-sky-200">
            <Zap className="mb-8 w-14 h-14 text-sky-600" />
            <h3 className="mb-4 text-2xl font-bold leading-snug text-sky-950">Thèm khát sự thay đổi ngoạn mục?</h3>
            <p className="leading-relaxed text-slate-600">Muốn biến tủ đồ nhàm chán đen kịt, tối thui thành màu sắc năng động trẻ trung, chuyển từ size XXL sang size S?</p>
          </Card>
        </div>
